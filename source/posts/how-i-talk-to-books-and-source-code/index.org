...
#+date: [2026-01-07 Wed]
#+last_modified: [2026-02-16 Mon]
#+description: An AI-powered approach to staying current in your expertise by connecting comprehensive technical books with real-world codebases to learn what's relevant and new for you in an efficient, interactive way.
...
#+html_head_extra: <meta name="twitter:image" content="https://fritzgrabo.com/posts/how-i-talk-to-books-and-source-code/og-image.jpeg">
...
#+html_head_extra: <meta property="og:image" content="https://fritzgrabo.com/posts/how-i-talk-to-books-and-source-code/og-image.jpeg">
...
*Update 2026-02-16:* @@html:<mark>@@I've since reworked the workflow described below into a standalone Claude Code skill called "Dev Book Study", available at [[https://github.com/fritzgrabo/dev-book-study][github.com/fritzgrabo/dev-book-study]].@@html:</mark>@@

The idea itself is technology-agnostic -- it works wherever you have access to both quality documentation and real-world code.

In this post, I'll demonstrate this method in the context of the Ruby on Rails framework, where I've been working for 15 years and consider myself an expert.
