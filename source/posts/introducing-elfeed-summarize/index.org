...
#+description: Add LLM-powered inline summaries to elfeed.
#+filetags: emacs
...
Bob Nadler kindly pointed me to his [[https://github.com/rnadler/elfeed-curate][~elfeed-curate~]] Emacs package (see [[https://bobonmedicaldevicesoftware.com/blog/2025/10/27/elfeed-curate-update-two-new-features/][blog post]]).
It adds functionality to curate RSS feeds to elfeed, and comes with a summarization feature similar to that of ~elfeed-summarize~.
Bob's variant is built on ~gptel~ and has slightly different UI mechanics.
Do check it out!
