...
For my usecase, I'm only interested in fetchin an issue's metadata ([[https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issues/#api-rest-api-2-issue-issueidorkey-get][API docs]]).
