...
* Back at work @@html:<small class="now-date">@@05/2026@@html:</small>@@

I'm back to something close to full-time work: two startups at a fixed number of hours per month each, plus the occasional small gig on the side. All engagements are interesting (though for entirely different reasons) and there's something particularly nice about having a steady rhythm again. Good to be back.

A new challenge is context switching at an intensity I haven't experienced before. Working across multiple clients in different business and tech domains, with a focus on different levels of detail simultaneously, means I've had to become very deliberate about how I block my time and swap out mental RAM. It's a skill I'm actively developing.

* Comprehension debt @@html:<small class="now-date">@@02/2026@@html:</small>@@

There's a term making the rounds lately: [[https://codemanship.wordpress.com/2025/09/30/comprehension-debt-the-ticking-time-bomb-of-llm-generated-code/][comprehension debt]] – the idea that when you accept code you don't fully understand, you're borrowing against your future ability to maintain and debug it. As with "technical debt", I follow [[https://x.com/jessitron/status/1123310331957145601][Jessica Kerr's argument]] that we should call it a /risk/ rather than a /debt/: it's not something you repay, it's something that quietly blows up on you.

I experienced it firsthand vibe-coding a small project for my kids' school — extending a codebase I had written myself, using AI to move faster. It became opaque to me surprisingly quickly.

That experience pushes me firmly outside the "agent-orchestration" camp. What resonates with me instead is treating AI like a pair programmer: small iterations, tight feedback loops, keeping responsibility squarely in my hands, and making sure I understand exactly what's happening at each step.

With that in mind, I've been doing a bit of work on AI tooling in the Emacs universe lately, and experimenting with what's out there more broadly. It's all very exciting!

On a personal note: work is picking up, which feels great. There's something particularly satisfying about building things alongside people you trust, and working on problems you care about.

* Building together @@html:<small class="now-date">@@12/2025@@html:</small>@@

After some time of figuring out what's next work-wise (see September), I've landed on something that feels right: I'm formalizing 15 years of freelance work by founding two cooperatives with friends.
We're covering augmentation of software development teams via [[https://awesome.at][awesome.at]] and full-service software project implementation via [[https://mitfreuden.com][mitfreuden.com]] – basically what I've been doing all along and what I'm good at, but now with the structure we'd never bothered to formalize.

Working with this trusted team means we can take on bigger implementation projects together, which opens up new possibilities beyond the embedded work we've been doing together already. Exciting!

After spending some time staying quiet to see what would emerge, and waiting to find out if I'd get pulled toward entirely different adventures, it's validating to realize I don't feel the need to reinvent myself. I can build on what I know and have done.

I'll probably work a little less though, to make room for the family and for other topics that have come up and that I want to investigate outside of work.
